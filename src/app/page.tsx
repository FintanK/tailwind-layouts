...
const categorizeLayouts = (names: string[]): { [key: string]: string[] } => {
  ...
  const categoryKeywords: { keyword: string[], category: string }[] = [
    ...
    { keyword: ['content - article with sidebar', 'content - overlapping image section', 'content - section with heading', 'content grid images and text', 'content masonry dynamic height', 'content grid with featured post', 'content section with author bio', 'content section with callout quote', 'content section with tabs', 'content two columns with images', 'content grid', 'content with sidebar', 'content masonry', 'content single column', 'content section'], category: 'Content Layout' },
